...
END
INTERJECT_COPY_TRANS ZBNEPHJ 1 ZB_NEPH_INTERJECT_1.2_1
...
END
INTERJECT_COPY_TRANS ZBNEPHJ 1 ZB_NEPH_INTERJECT_1.2_2
...
END
INTERJECT_COPY_TRANS ZBNEPHJ 1 ZB_NEPH_INTERJECT_1.2_3
...
END
INTERJECT_COPY_TRANS ZBNEPHJ 1 ZB_NEPH_INTERJECT_1.2_4
...
END
INTERJECT_COPY_TRANS ZBNEPHJ 1 ZB_NEPH_INTERJECT_1.2_5
...
END
INTERJECT_COPY_TRANS ZBNEPHJ 1 ZB_NEPH_INTERJECT_1.2_6
...
END
INTERJECT_COPY_TRANS ZBNEPHJ 2.1 ZBPOSTMATCH2_6
...
END
INTERJECT_COPY_TRANS ZBNEPHJ 2.1 ZBPOSTMATCH2_7
...
END
INTERJECT_COPY_TRANS ZBNEPHJ 2.1 ZBPOSTMATCH2_8
...
END
INTERJECT_COPY_TRANS ZBNEPHJ 3 ZBNEPHPREMATCH3_2
...
END
INTERJECT_COPY_TRANS ZBNEPHJ 3 ZBNEPHPREMATCH3_3
...
END
INTERJECT_COPY_TRANS ZBNEPHJ 3 ZBNEPHPREMATCH3_4
...
/// Before Match 4
INTERJECT_COPY_TRANS ZBNEPHJ 4 ZBPREMATCH4_1
...
END
INTERJECT_COPY_TRANS ZBNEPHJ 4 ZBPREMATCH4_2
...
END
INTERJECT_COPY_TRANS ZBNEPHJ 4 ZBPREMATCH4_3
...
END
INTERJECT_COPY_TRANS ZBNEPHJ 4 ZBPREMATCH4_4
...
/// Before Match 5
INTERJECT_COPY_TRANS ZBNEPHJ 7 ZBPREMATCH5.1_1
  == VICONIJ IF ~InMyArea("Viconia") !StateCheck("Viconia",CD_STATE_NOTVALID)~ THEN @61 /* Hmph. I wonder what fate befell their house? Only the weak would allow themselves to be captured by surfacers. */
END
INTERJECT_COPY_TRANS ZBNEPHJ 7 ZBPREMATCH5.1_2
...
/// Neph help
INTERJECT_COPY_TRANS ZBNEPHJ 8 ZBPREMATCH5.2_1
...
END
INTERJECT_COPY_TRANS ZBNEPHJ 8 ZBPREMATCH5.2_2
...
END
INTERJECT_COPY_TRANS ZBNEPHJ 8 ZBPREMATCH5.2_3
...
END
INTERJECT_COPY_TRANS ZBNEPHJ 8 ZBPREMATCH5.2_4
...
END
INTERJECT_COPY_TRANS ZBNEPHJ 8 ZBPREMATCH5.2_5
...
END
INTERJECT_COPY_TRANS ZBNEPHJ 8 ZBPREMATCH5.2_6
...
/// After Match 5 ///
// Fight
INTERJECT_COPY_TRANS ZBNEPH zbnephfight ZBPOSTMATCH5.1_1
...
END
INTERJECT_COPY_TRANS ZBNEPH zbnephfight ZBPOSTMATCH5.1_2
...
END
INTERJECT_COPY_TRANS ZBNEPH zbnephfight ZBPOSTMATCH5.1_3
...
// No fight
INTERJECT_COPY_TRANS ZBNEPH zbnephnofight ZBPOSTMATCH5.2_1
  == YOSHJ IF ~ !StateCheck("Yoshimo",CD_STATE_NOTVALID) InParty("Yoshimo") InMyArea("Yoshimo")~ THEN @328 /* Oh? I am most intrigued. Let’s not tarry too long, no? */
END
INTERJECT_COPY_TRANS ZBNEPH zbnephnofight ZBPOSTMATCH5.2_2
  == NALIAJ IF ~!StateCheck("Nalia",CD_STATE_NOTVALID) InParty("Nalia") InMyArea("Nalia")~ THEN @329 /* I love sneaking around. Reminds me of simpler times. */
END
INTERJECT_COPY_TRANS ZBNEPH zbnephnofight ZBPOSTMATCH5.2_3
  == EDWINJ IF ~!StateCheck("EDWIN", CD_STATE_NOTVALID) InParty("EDWIN") InMyArea("EDWIN")~ THEN @330 /* Eh, keep your guard up. I will not be held responsible if the tiefling girl ambushes us with the many spies she undoubtedly keeps in her back pocket (I can *feel* them watching.) */
END
///

/// Ring Interject ///
INTERJECT_COPY_TRANS ZBNEPH zbnephstudyring ZBPOSTMATCH5.2_1
...
END
INTERJECT_COPY_TRANS ZBNEPH zbnephstudyring ZBPOSTMATCH5.2_2
...
END
INTERJECT_COPY_TRANS ZBNEPH zbnephstudyring ZBPOSTMATCH5.2_3
...
END
INTERJECT_COPY_TRANS ZBNEPH zbnephstudyring ZBPOSTMATCH5.2_4
...
END
INTERJECT_COPY_TRANS ZBNEPH zbnephstudyring ZBPOSTMATCH5.2_5
...
INTERJECT_COPY_TRANS ZBNEPH ZBNEPHCOWLEDWIZARDS ZBNEPHFIRSTJOINSINTERJECT1_1
...
END
INTERJECT_COPY_TRANS ZBNEPH ZBNEPHCOWLEDWIZARDS ZBNEPHFIRSTJOINSINTERJECT1_2
...
END
INTERJECT_COPY_TRANS ZBNEPH ZBNEPHCOWLEDWIZARDS ZBNEPHFIRSTJOINSINTERJECT1_3
...
END
INTERJECT_COPY_TRANS ZBNEPH ZBNEPHCOWLEDWIZARDS ZBNEPHFIRSTJOINSINTERJECT1_4
...
END
INTERJECT_COPY_TRANS ZBNEPH ZBNEPHCOWLEDWIZARDS ZBNEPHFIRSTJOINSINTERJECT1_5
...
END
INTERJECT_COPY_TRANS ZBNEPH ZBNEPHCOWLEDWIZARDS ZBNEPHFIRSTJOINSINTERJECT1_6
...
END
INTERJECT_COPY_TRANS ZBNEPH ZBNEPHCOWLEDWIZARDS ZBNEPHFIRSTJOINSINTERJECT1_7
...
END
INTERJECT_COPY_TRANS ZBNEPH ZBNEPHCOWLEDWIZARDS ZBNEPHFIRSTJOINSINTERJECT1_8
  == WILSONJ IF ~InParty("WILSON") InMyArea("WILSON") !StateCheck("WILSON",CD_STATE_NOTVALID)~ THEN @363 /* *growl* *snort* */
END


INTERJECT_COPY_TRANS ZBNEPH ZBNEPHILLBEBYYOURSIDE ZBNEPHFIRSTJOINSINTERJECT2_1
  == HAERDAJ IF ~InParty("HaerDalis") InMyArea("HaerDalis") !StateCheck("HaerDalis",CD_STATE_NOTVALID)~ THEN @356 /* We must consider ourselves fortunate to find another exotic bird to join our eccentric menagerie. */
END
INTERJECT_COPY_TRANS ZBNEPH ZBNEPHILLBEBYYOURSIDE ZBNEPHFIRSTJOINSINTERJECT2_2
  == EDWINJ IF ~InParty("EDWIN") InMyArea("EDWIN") !StateCheck("EDWIN",CD_STATE_NOTVALID)~ THEN @357 /* Eh? No, no this will not do at all. I will not tolerate spies within my company. I will be keeping an eye on you, tiefling. (Or… perhaps both eyes). */
END
INTERJECT_COPY_TRANS ZBNEPH ZBNEPHILLBEBYYOURSIDE ZBNEPHFIRSTJOINSINTERJECT2_3
  == ANOMENJ IF ~InParty("ANOMEN") InMyArea("ANOMEN") !StateCheck("ANOMEN",CD_STATE_NOTVALID)~ THEN @358 /* Taking in every fantastical stray you find is going to end poorly for you, <CHARNAME>. */
END
INTERJECT_COPY_TRANS ZBNEPH ZBNEPHILLBEBYYOURSIDE ZBNEPHFIRSTJOINSINTERJECT2_4
  == MINSCJ IF ~InParty("Minsc") InMyArea("Minsc") !StateCheck("Minsc",CD_STATE_NOTVALID)~ THEN @359 /* Huzzah! Boo was worried you would not be coming with us. I think he likes you. */
END
INTERJECT_COPY_TRANS ZBNEPH ZBNEPHILLBEBYYOURSIDE ZBNEPHFIRSTJOINSINTERJECT2_5
  == AERIEJ IF ~InParty("AERIE") InMyArea("AERIE") !StateCheck("AERIE",CD_STATE_NOTVALID)~ THEN @360 /* W-welcome. I hope you like c-crazy adventures, that’s the only kind we seem to go on. */
END
INTERJECT_COPY_TRANS ZBNEPH ZBNEPHILLBEBYYOURSIDE ZBNEPHFIRSTJOINSINTERJECT2_6
  == KELDORJ IF ~InParty("Keldorn") InMyArea("Keldorn") !StateCheck("Keldorn",CD_STATE_NOTVALID)~ THEN @361 /* I’ll be keeping a close eye on you, planeling. */
END
INTERJECT_COPY_TRANS ZBNEPH ZBNEPHILLBEBYYOURSIDE ZBNEPHFIRSTJOINSINTERJECT2_7
  == YOSHJ IF ~InParty("Yoshimo") InMyArea("Yoshimo") !StateCheck("Yoshimo",CD_STATE_NOTVALID)~ THEN @362 /* And here I thought this group had reached its limit for talented rogues. Ah, no matter. More competition is always welcome! */
END
INTERJECT_COPY_TRANS ZBNEPH ZBNEPHILLBEBYYOURSIDE ZBNEPHFIRSTJOINSINTERJECT2_8
  == WILSONJ IF ~InParty("WILSON") InMyArea("WILSON") !StateCheck("WILSON",CD_STATE_NOTVALID)~ THEN @363 /* *growl* *snort* */
END

INTERJECT_COPY_TRANS ZBNEPH ZBNEPHONTOTHEROAD ZBNEPHFIRSTJOINSINTERJECT3_1
  == HAERDAJ IF ~InParty("HaerDalis") InMyArea("HaerDalis") !StateCheck("HaerDalis",CD_STATE_NOTVALID)~ THEN @356 /* We must consider ourselves fortunate to find another exotic bird to join our eccentric menagerie. */
END
INTERJECT_COPY_TRANS ZBNEPH ZBNEPHONTOTHEROAD ZBNEPHFIRSTJOINSINTERJECT3_2
  == EDWINJ IF ~InParty("EDWIN") InMyArea("EDWIN") !StateCheck("EDWIN",CD_STATE_NOTVALID)~ THEN @357 /* Eh? No, no this will not do at all. I will not tolerate spies within my company. I will be keeping an eye on you, tiefling. (Or… perhaps both eyes). */
END
INTERJECT_COPY_TRANS ZBNEPH ZBNEPHONTOTHEROAD ZBNEPHFIRSTJOINSINTERJECT3_3
  == ANOMENJ IF ~InParty("ANOMEN") InMyArea("ANOMEN") !StateCheck("ANOMEN",CD_STATE_NOTVALID)~ THEN @358 /* Taking in every fantastical stray you find is going to end poorly for you, <CHARNAME>. */
END
INTERJECT_COPY_TRANS ZBNEPH ZBNEPHONTOTHEROAD ZBNEPHFIRSTJOINSINTERJECT3_4
  == MINSCJ IF ~InParty("Minsc") InMyArea("Minsc") !StateCheck("Minsc",CD_STATE_NOTVALID)~ THEN @359 /* Huzzah! Boo was worried you would not be coming with us. I think he likes you. */
END
INTERJECT_COPY_TRANS ZBNEPH ZBNEPHONTOTHEROAD ZBNEPHFIRSTJOINSINTERJECT3_5
  == AERIEJ IF ~InParty("AERIE") InMyArea("AERIE") !StateCheck("AERIE",CD_STATE_NOTVALID)~ THEN @360 /* W-welcome. I hope you like c-crazy adventures, that’s the only kind we seem to go on. */
END
INTERJECT_COPY_TRANS ZBNEPH ZBNEPHONTOTHEROAD ZBNEPHFIRSTJOINSINTERJECT3_6
  == KELDORJ IF ~InParty("Keldorn") InMyArea("Keldorn") !StateCheck("Keldorn",CD_STATE_NOTVALID)~ THEN @361 /* I’ll be keeping a close eye on you, planeling. */
END
INTERJECT_COPY_TRANS ZBNEPH ZBNEPHONTOTHEROAD ZBNEPHFIRSTJOINSINTERJECT3_7
  == YOSHJ IF ~InParty("Yoshimo") InMyArea("Yoshimo") !StateCheck("Yoshimo",CD_STATE_NOTVALID)~ THEN @362 /* And here I thought this group had reached its limit for talented rogues. Ah, no matter. More competition is always welcome! */
END
INTERJECT_COPY_TRANS ZBNEPH ZBNEPHONTOTHEROAD ZBNEPHFIRSTJOINSINTERJECT3_8
  == WILSONJ IF ~InParty("WILSON") InMyArea("WILSON") !StateCheck("WILSON",CD_STATE_NOTVALID)~ THEN @363 /* *growl* *snort* */
END
